...
/* API */
import { filterFetcherDispute } from 'api/comments';
...
import { filterFieldsDisputes } from 'components/helpers/fields/comments';
/* Modules */
    ...
    return (
      <React.Fragment>
        <IndexTable
          ...
          filterFields={filterFieldsDisputes()}
          filterFetcher={filterFetcherDispute}
          resource={resource}
...
export default withRouter(connectList(
  resource,
  SET_LIST,
  resourceFetcher(filterFetcherDispute, resource, true),
