...
/* Helpers */
import { fieldsNew } from 'components/helpers/fields/permits';
...
class New extends React.Component {
  ...
  renderFields () {
    ...
    return renderFieldsWithGrid(fieldsNew(roles, agencies, parkingLots, roleType), 3, 4, { ...this.fieldProps(), errors: this.state.errors });
  }
